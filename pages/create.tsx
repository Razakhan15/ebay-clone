        ...
        <div className="flex overflow-x-scroll space-x-2 p-4">
          {ownedNfts?.data?.map((nft) => (
            <div
              ...
              className={`flex flex-col scroll-py-2 card min-w-fit border-2 bg-gray-100 ${
            ...
            <div className="flex flex-col p-10">
              <div className="grid grid-cols-2 gap-5">
                ...
                <input
                  ...
                  name="listingType"
                />
                <label className="font-light border-r">Pirce</label>
                <input
                  type="text"
                  name="price"
                  placeholder="0.05"
              ...
              <button
                className="bg-blue-500 text-white font-bold py-2 px-4 rounded cursor-pointer mt-8"
                type="submit"
              >
                Create Listing
              </button>
